            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      const Text("TOTAL stims", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
                  ...
                  Column(
                    children: [
                      const Text("stim LEVEL", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
                      const SizedBox(height: 4),
            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("HE'S COMING"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("GEM ALERT"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("ABSOLUTE COAL"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("IT'S OVER"),
                ),
              ],
            ),
